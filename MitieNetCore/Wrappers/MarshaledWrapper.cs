using MitieNetCore.Util;
using System;
using System.Collections.Generic;
using System.Runtime.InteropServices;

namespace MitieNetCore.Wrappers
{
    // From Mitie:
    ...
    /// <summary>
    /// 
    /// Copyright © 2020 Sam Morreel, SaasyCloud.com
    /// 
    /// This wrapper class can be used as a independant flat API call space to the Mitie library.
    /// 
    /// </summary>
    public static class MarshaledWrapper
    {
       private const string MITIE_DLL_NAME = "mitie.dll";
        /*!
        ...
        !*/
        [DllImport(MITIE_DLL_NAME, 
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_free(IntPtr obj);

        /// <summary>
        /// Frees an object allocated by the Mitie library.
        /// Any resources allocated by Mitie must be freed by the caller,
        /// where indicated.
        /// </summary>
        /// <param name="obj">The object.</param>
        /// <returns></returns>
        public static uint Exec_mitie_free(IntPtr obj)
        {
            return mitie_free(obj);
        }
        ...
        !*/    
        [DllImport(MITIE_DLL_NAME, CharSet = CharSet.Auto, 
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_load_entire_file([MarshalAs(UnmanagedType.LPStr)] string filename);

        /// <summary>
        /// Loads an entire text file for Mitie to process.
        /// This method will return the text of the file. It also returns the unmanaged pointer
        /// to the memory allocated by Mitie in order to give the caller the choice to 
        /// free memory manually. The default is to free the memory.
        /// </summary>
        /// <param name="filename">The filename.</param>
        /// <param name="unmanagedPtr">The unmanaged PTR.</param>
        /// <param name="freeUnmanaged">if set to <c>true</c> [free unmanaged].</param>
        /// <returns></returns>
        public static string Exec_mitie_load_entire_file(string filename, 
                                                         ref IntPtr unmanagedPtr, 
                                                         bool freeUnmanaged = true)
        {
            unmanagedPtr = mitie_load_entire_file(filename);
            string str = Marshal.PtrToStringAnsi(unmanagedPtr);

            if (freeUnmanaged == true)
            {
                mitie_free(unmanagedPtr);
        ...
        [DllImport(MITIE_DLL_NAME, CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_tokenize([MarshalAs(UnmanagedType.LPStr)] string text);

        public static List<string> Exec_mitie_tokenize(string text,
                                                       ref IntPtr unmanagedPtr,
                                                       bool freeUnmanaged = false)
        {
            unmanagedPtr = mitie_tokenize(text);
            return Helpers.IntPtrToStringArrayAnsi(ref unmanagedPtr, freeUnmanaged);
        }
        ...
        [DllImport(MITIE_DLL_NAME, CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_tokenize_file([MarshalAs(UnmanagedType.LPStr)] string filename);

        public static List<string> Exec_mitie_tokenize_file(string filename,
                                                            ref IntPtr unmanagedPtr,
                                                            bool freeUnmanaged = false)
        {
            unmanagedPtr = mitie_tokenize_file(filename);
            return Helpers.IntPtrToStringArrayAnsi(ref unmanagedPtr, freeUnmanaged);
        }
        ...
        [DllImport(MITIE_DLL_NAME, CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_tokenize_with_offsets([MarshalAs(UnmanagedType.LPStr)] string text,
                                                                  out IntPtr token_offsets);

        public static List<string> Exec_mitie_tokenize_with_offsets(string text,
                                                                    ref List<uint> token_offsets,
                                                                    ref IntPtr ptrTokens,
                                                                    ref IntPtr ptrOffsetTokens,
                                                                    bool freeUnmanaged = false)
        {
            IntPtr ptrTemp = mitie_tokenize(text);
            List<string> tokens = Helpers.IntPtrToStringArrayAnsi(ref ptrTemp, true);

            ptrTokens = mitie_tokenize_with_offsets(text, out ptrOffsetTokens);

            token_offsets = Helpers.MarshalLongArrayToUintList(ref ptrOffsetTokens, 
                                                              (uint)tokens.Count, 
                                                              freeUnmanaged);

            if (freeUnmanaged == true)
            {
                mitie_free(ptrTokens);
                ptrTokens = IntPtr.Zero;
            }
        ...
        [DllImport(MITIE_DLL_NAME, CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_load_named_entity_extractor([MarshalAs(UnmanagedType.LPStr)] string filename);

        public static IntPtr Exec_mitie_load_named_entity_extractor(string filename)
        {
            return mitie_load_named_entity_extractor(filename);
        }
        ...
        [DllImport(MITIE_DLL_NAME, CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_load_named_entity_extractor_pure_model([MarshalAs(UnmanagedType.LPStr)] string filename,
                                                                                  [MarshalAs(UnmanagedType.LPStr)] string fe_filename);

        public static IntPtr Exec_mitie_load_named_entity_extractor_pure_model(string filename,
                                                                               string feFilename)
        {
            return mitie_load_named_entity_extractor_pure_model(filename, feFilename);
        }
        ...
        [DllImport(MITIE_DLL_NAME, CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_check_ner_pure_model([MarshalAs(UnmanagedType.LPStr)] string filename);

        public static int Exec_mitie_check_ner_pure_model(string filename)
        {
            return mitie_check_ner_pure_model(filename);
        }
        ...
        [DllImport(MITIE_DLL_NAME, CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_load_named_entity_extractor_pure_model_without_feature_extractor([MarshalAs(UnmanagedType.LPStr)] string filename);

        public static IntPtr Exec_mitie_load_named_entity_extractor_pure_model_without_feature_extractor(string filename)
        {
            return mitie_load_named_entity_extractor_pure_model_without_feature_extractor(filename);
        }
        ...
        [DllImport(MITIE_DLL_NAME, CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_get_num_possible_ner_tags(IntPtr ner);

        public static uint Exec_mitie_get_num_possible_ner_tags(IntPtr ner)
        {
            return mitie_get_num_possible_ner_tags(ner);
        }
        ...
        [DllImport(MITIE_DLL_NAME, CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_get_named_entity_tagstr(IntPtr ner,
                                                                   uint idx);

        public static string Exec_mitie_get_named_entity_tagstr(IntPtr ner,
                                                                uint idx)
        {
            return Marshal.PtrToStringAnsi(mitie_get_named_entity_tagstr(ner, idx));
        }
        ...
        /*!
            ...
            ensures
                ...
                - If the object can't be created then this function returns NULL
        !*/
        [DllImport("mitie.dll", CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_extract_entities(IntPtr ner, 
                                                            IntPtr tokens);

        public static IntPtr Exec_mitie_extract_entities(IntPtr ner,
                                                         IntPtr tokens)
        {
            return mitie_extract_entities(ner, tokens);
        }
        ...
        [DllImport("mitie.dll", CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_extract_entities_with_extractor(IntPtr ner,
                                                                           IntPtr tokens,
                                                                           IntPtr fe);

        public static IntPtr Exec_mitie_extract_entities_with_extractor(IntPtr ner,
                                                                        IntPtr tokens,
                                                                        IntPtr fe)
        {
            return mitie_extract_entities_with_extractor(ner,
                                                         tokens,
                                                         fe);
        }
        ...
        [DllImport("mitie.dll", CharSet = CharSet.Auto,
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_ner_get_num_detections(IntPtr dets);

        public static uint Exec_mitie_ner_get_num_detections(IntPtr detections)
        {
            return mitie_ner_get_num_detections(detections);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_ner_get_detection_position(IntPtr dets, 
                                                                    uint idx);

        public static uint Exec_mitie_ner_get_detection_position(IntPtr detections, 
                                                                 uint idx)
        {
            return mitie_ner_get_detection_position(detections, idx);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_ner_get_detection_length(IntPtr dets, 
                                                                  uint idx);

        public static uint Exec_mitie_ner_get_detection_length(IntPtr detections, 
                                                               uint idx)
        {
            return mitie_ner_get_detection_length(detections, idx);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_ner_get_detection_tag(IntPtr dets, 
                                                               uint idx);

        public static uint Exec_mitie_ner_get_detection_tag(IntPtr detections, 
                                                            uint idx)
        {
            return mitie_ner_get_detection_tag(detections, idx);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_ner_get_detection_tagstr(IntPtr dets, 
                                                                    uint idx);

        public static string Exec_mitie_ner_get_detection_tagstr(IntPtr detections,
                                                                 uint idx)
        {
            return Marshal.PtrToStringAnsi(mitie_ner_get_detection_tagstr(detections, idx));
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern double mitie_ner_get_detection_score(IntPtr dets,
                                                                   uint idx);

        public static double Exec_mitie_ner_get_detection_score(IntPtr detections,
                                                                uint idx)
        {
            return mitie_ner_get_detection_score(detections, idx);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_load_binary_relation_detector([MarshalAs(UnmanagedType.LPStr)] string filename);

        public static IntPtr Exec_mitie_load_binary_relation_detector(string filename)
        {
            return mitie_load_binary_relation_detector(filename);
        }
       ...
       !*/
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_binary_relation_detector_name_string(IntPtr detector);

        public static string Exec_mitie_binary_relation_detector_name_string(IntPtr detector)
        {
            return Marshal.PtrToStringAnsi(mitie_binary_relation_detector_name_string(detector));
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_extract_binary_relation(IntPtr ner,
                                                                   IntPtr tokens,
                                                                   uint arg1_start,
                                                                   uint arg1_length,
                                                                   uint arg2_start,
        ...
        public static IntPtr Exec_mitie_extract_binary_relation(IntPtr ner,
                                                                IntPtr tokens,
                                                                uint arg1_start,
                                                                uint arg1_length,
                                                                uint arg2_start,
                                                                uint arg2_length)
        {
            return mitie_extract_binary_relation(ner,
                                                 tokens,
                                                 arg1_start,
                                                 arg1_length,
                                                 arg2_start,
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_classify_binary_relation(IntPtr detector,
                                                                 IntPtr relation,
                                                                 out double score);

        public static int Exec_mitie_classify_binary_relation(IntPtr detector,
                                                              IntPtr relation,
                                                              out double score)
        {
            return mitie_classify_binary_relation(detector,
                                                  relation,
                                                  out score);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_load_text_categorizer([MarshalAs(UnmanagedType.LPStr)] string filename);

        public static IntPtr Exec_mitie_load_text_categorizer(string filename)
        {
            return mitie_load_text_categorizer(filename);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_load_text_categorizer_pure_model([MarshalAs(UnmanagedType.LPStr)] string filename,
                                                                            [MarshalAs(UnmanagedType.LPStr)] string fe_filename);

        public static IntPtr Exec_mitie_load_text_categorizer_pure_model(string filename,
                                                                         string fe_filename)
        {
            return mitie_load_text_categorizer_pure_model(filename,
                                                          fe_filename);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_check_text_categorizer_pure_model([MarshalAs(UnmanagedType.LPStr)] string filename);

        public static int Exec_mitie_check_text_categorizer_pure_model(string filename)
        {
            return mitie_check_text_categorizer_pure_model(filename);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_load_text_categorizer_pure_model_without_feature_extractor([MarshalAs(UnmanagedType.LPStr)] string filename);

        public static IntPtr Exec_mitie_load_text_categorizer_pure_model_without_feature_extractor(string filename)
        {
            return mitie_load_text_categorizer_pure_model_without_feature_extractor(filename);
        }
       ...
       !*/
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_categorize_text(IntPtr tcat,
                                                        IntPtr tokens,
                                                        out IntPtr text_tag,
                                                        out double text_score);

        public static int Exec_mitie_categorize_text(IntPtr tcat,
                                                     IntPtr tokens,
                                                     out IntPtr text_tag,
                                                     out double text_score)

        {
            return mitie_categorize_text(tcat,
                                         tokens,
                                         out text_tag,
                                         out text_score);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_categorize_text_with_extractor(IntPtr tcat,
                                                                       IntPtr tokens,
                                                                       out IntPtr text_tag,
                                                                       out double text_score,
                                                                       IntPtr fe);

        public static int Exec_mitie_categorize_text_with_extractor(IntPtr tcat,
                                                     IntPtr tokens,
                                                     out IntPtr text_tag,
                                                     out double text_score,
                                                     IntPtr fe)
        ...
        {
            return mitie_categorize_text_with_extractor(tcat,
                                                        tokens,
                                                        out text_tag,
                                                        out text_score,
                                                        fe);
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_save_named_entity_extractor([MarshalAs(UnmanagedType.LPStr)] string filename,
                                                                    IntPtr ner);

        public static int Exec_mitie_save_named_entity_extractor(string filename,
                                                                 IntPtr ner)
        {
            return mitie_save_named_entity_extractor(filename,
                                                     ner);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_save_named_entity_extractor_pure_model([MarshalAs(UnmanagedType.LPStr)] string filename,
                                                                               IntPtr ner);

        public static int Exec_mitie_save_named_entity_extractor_pure_model(string filename,
                                                                            IntPtr ner)
        {
            return mitie_save_named_entity_extractor_pure_model(filename,
                                                                ner);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_save_binary_relation_detector([MarshalAs(UnmanagedType.LPStr)] string filename,
                                                                      IntPtr detector);

        public static int Exec_mitie_save_binary_relation_detector(string filename,
                                                                   IntPtr detector)
        {
            return mitie_save_binary_relation_detector(filename,
                                                       detector);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_save_text_categorizer([MarshalAs(UnmanagedType.LPStr)] string filename,
                                                              IntPtr tcat);

        public static int Exec_mitie_save_text_categorizer(string filename,
                                                           IntPtr tcat)
        {
            return mitie_save_text_categorizer(filename,
                                               tcat);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_save_text_categorizer_pure_model([MarshalAs(UnmanagedType.LPStr)] string filename,
                                                                         IntPtr tcat);

        public static int Exec_mitie_save_text_categorizer_pure_model(string filename,
                                                                      IntPtr tcat)
        {
            return mitie_save_text_categorizer_pure_model(filename,
                                                          tcat);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_create_ner_training_instance(IntPtr tokens);

        public static IntPtr Exec_mitie_create_ner_training_instance(IntPtr tokens)
        {
            return mitie_create_ner_training_instance(tokens);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_ner_training_instance_num_tokens(IntPtr instance);

        public static uint Exec_mitie_ner_training_instance_num_tokens(IntPtr instance)
        {
            return mitie_ner_training_instance_num_tokens(instance);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_ner_training_instance_num_entities(IntPtr instance);

        public static uint Exec_mitie_ner_training_instance_num_entities(IntPtr instance)
        {
            return mitie_ner_training_instance_num_entities(instance);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_overlaps_any_entity(IntPtr instance,
                                                            uint start,
                                                            uint length);
        
        public static int Exec_mitie_overlaps_any_entity(IntPtr instance,
                                                          uint start,
                                                          uint length)
        {
            return mitie_overlaps_any_entity(instance,
                                             start,
                                             length);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_add_ner_training_entity(IntPtr instance,
                                                                uint start,
                                                                uint length,
                                                                [MarshalAs(UnmanagedType.LPStr)] string label);

        public static int Exec_mitie_add_ner_training_entity(IntPtr instance,
                                                             uint start,
                                                             uint length,
                                                             string label)
        {
            return mitie_add_ner_training_entity(instance,
                                                 start,
                                                 length,
                                                 label);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_create_ner_trainer([MarshalAs(UnmanagedType.LPStr)] string filename);

        public static IntPtr Exec_mitie_create_ner_trainer(string filename)
        {
            return mitie_create_ner_trainer(filename);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_ner_trainer_size(IntPtr trainer);

        public static uint Exec_mitie_ner_trainer_size(IntPtr trainer)
        {
            return mitie_ner_trainer_size(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_add_ner_training_instance(IntPtr trainer,
                                                                  IntPtr instance);

        public static int Exec_mitie_add_ner_training_instance(IntPtr trainer,
                                                                IntPtr instance)
        {
            return mitie_add_ner_training_instance(trainer,
                                                   instance);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern void mitie_ner_trainer_set_beta(IntPtr trainer,
                                                              double beta);

        public static void Exec_mitie_ner_trainer_set_beta(IntPtr trainer,
                                                           double beta)
        {
            mitie_ner_trainer_set_beta(trainer,
                                       beta);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern double mitie_ner_trainer_get_beta(IntPtr trainer);

        public static void Exec_mitie_ner_trainer_get_beta(IntPtr trainer)
        {
            mitie_ner_trainer_get_beta(trainer);
        }
        ...
        [DllImport("mitie.dll",
          CallingConvention = CallingConvention.Cdecl)]
        private static extern void mitie_ner_trainer_set_num_threads(IntPtr trainer,
                                                                     uint num_threads);

        public static void Exec_mitie_ner_trainer_set_num_threads(IntPtr trainer,
                                                                  uint num_threads)
        {
            mitie_ner_trainer_set_num_threads(trainer,
                                              num_threads);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_ner_trainer_get_num_threads(IntPtr trainer);

        public static void Exec_mitie_ner_trainer_get_num_threads(IntPtr trainer)
        {
            mitie_ner_trainer_get_num_threads(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_train_named_entity_extractor(IntPtr trainer);

        public static IntPtr Exec_mitie_train_named_entity_extractor(IntPtr trainer)
        {
            return mitie_train_named_entity_extractor(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_create_binary_relation_trainer([MarshalAs(UnmanagedType.LPStr)] string relation_name,
                                                                          IntPtr ner);

        public static IntPtr Exec_mitie_create_binary_relation_trainer(string relation_name,
                                                                       IntPtr ner)
        {
            return mitie_create_binary_relation_trainer(relation_name,
                                                        ner);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_binary_relation_trainer_num_positive_examples(IntPtr trainer);

        public static uint Exec_mitie_binary_relation_trainer_num_positive_examples(IntPtr trainer)
        {
            return mitie_binary_relation_trainer_num_positive_examples(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_binary_relation_trainer_num_negative_examples(IntPtr trainer);

        public static uint Exec_mitie_binary_relation_trainer_num_negative_examples(IntPtr trainer)
        {
            return mitie_binary_relation_trainer_num_negative_examples(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_add_positive_binary_relation(IntPtr trainer,
                                                                     IntPtr tokens,
                                                                     uint arg1_start,
                                                                     uint arg1_length,
                                                                     uint arg2_start,
        ...
        public static int Exec_mitie_add_positive_binary_relation(IntPtr trainer,
                                                                   IntPtr tokens,
                                                                   uint arg1_start,
                                                                   uint arg1_length,
                                                                   uint arg2_start,
                                                                   uint arg2_length)
        {
            return mitie_add_positive_binary_relation(trainer,
                                                      tokens,
                                                      arg1_start,
                                                      arg1_length,
                                                      arg2_start,
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_add_negative_binary_relation(IntPtr trainer,
                                                                     IntPtr tokens,
                                                                     uint arg1_start,
                                                                     uint arg1_length,
                                                                     uint arg2_start,
        ...
        public static int Exec_mitie_add_negative_binary_relation(IntPtr trainer,
                                                                  IntPtr tokens,
                                                                  uint arg1_start,
                                                                  uint arg1_length,
                                                                  uint arg2_start,
                                                                  uint arg2_length)
        {
            return mitie_add_negative_binary_relation(trainer,
                                                      tokens,
                                                      arg1_start,
                                                      arg1_length,
                                                      arg2_start,
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern void mitie_binary_relation_trainer_set_beta(IntPtr trainer,
                                                                          double beta);

        public static void Exec_mitie_binary_relation_trainer_set_beta(IntPtr trainer,
                                                                       double beta)
        {
            mitie_binary_relation_trainer_set_beta(trainer,
                                                   beta);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern double mitie_binary_relation_trainer_get_beta(IntPtr trainer);

        public static double Exec_mitie_binary_relation_trainer_get_beta(IntPtr trainer)
        {
            return mitie_binary_relation_trainer_get_beta(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern void mitie_binary_relation_trainer_set_num_threads(IntPtr trainer,
                                                                                 uint num_threads);

        public static void Exec_mitie_binary_relation_trainer_set_num_threads(IntPtr trainer,
                                                                              uint num_threads)
        {
            mitie_binary_relation_trainer_set_num_threads(trainer,
                                                          num_threads);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_binary_relation_trainer_get_num_threads(IntPtr trainer);

        public static uint Exec_mitie_binary_relation_trainer_get_num_threads(IntPtr trainer)
        {
            return mitie_binary_relation_trainer_get_num_threads(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_train_binary_relation_detector(IntPtr trainer);

        public static IntPtr Exec_mitie_train_binary_relation_detector(IntPtr trainer)
        {
            return mitie_train_binary_relation_detector(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr  mitie_create_text_categorizer_trainer([MarshalAs(UnmanagedType.LPStr)] string filename);

        public static IntPtr Exec_mitie_create_text_categorizer_trainer(string filename)
        {
            return mitie_create_text_categorizer_trainer(filename);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_text_categorizer_trainer_size(IntPtr trainer);

        public static uint Exec_mitie_text_categorizer_trainer_size(IntPtr trainer)
        {
            return mitie_text_categorizer_trainer_size(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern void mitie_text_categorizer_trainer_set_beta(IntPtr trainer,
                                                                           double beta);

        public static void Exec_mitie_text_categorizer_trainer_set_beta(IntPtr trainer,
                                                                        double beta)
        {
            mitie_text_categorizer_trainer_set_beta(trainer,
                                                    beta);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern double mitie_text_categorizer_trainer_get_beta(IntPtr trainer);

        public static double Exec_mitie_text_categorizer_trainer_get_beta(IntPtr trainer)
        {
            return mitie_text_categorizer_trainer_get_beta(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern void mitie_text_categorizer_trainer_set_num_threads(IntPtr trainer,
                                                                                  uint num_threads);

        public static void Exec_mitie_text_categorizer_trainer_set_num_threads(IntPtr trainer,
                                                                               uint num_threads)
        {
            mitie_text_categorizer_trainer_set_num_threads(trainer,
                                                           num_threads);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_text_categorizer_trainer_get_num_threads(IntPtr trainer);

        public static uint Exec_mitie_text_categorizer_trainer_get_num_threads(IntPtr trainer)
        {
            return mitie_text_categorizer_trainer_get_num_threads(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_add_text_categorizer_labeled_text(IntPtr trainer,
                                                                          IntPtr tokens,
                                                                          IntPtr label);

        public static int Exec_mitie_add_text_categorizer_labeled_text(IntPtr trainer,
                                                                       IntPtr tokens,
                                                                       IntPtr label)
        {
            return mitie_add_text_categorizer_labeled_text(trainer,
                                                           tokens,
                                                           label);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_train_text_categorizer(IntPtr trainer);

        public static IntPtr Exec_mitie_train_text_categorizer(IntPtr trainer)
        {
            return mitie_train_text_categorizer(trainer);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_load_total_word_feature_extractor([MarshalAs(UnmanagedType.LPStr)] string filename);

        public static IntPtr Exec_mitie_load_total_word_feature_extractor(string filename)
        {
            return mitie_load_total_word_feature_extractor(filename);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_total_word_feature_extractor_fingerprint(IntPtr twfe);

        public static uint Exec_mitie_total_word_feature_extractor_fingerprint(IntPtr twfe)
        {
            return mitie_total_word_feature_extractor_fingerprint(twfe);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_total_word_feature_extractor_num_dimensions(IntPtr twfe);

        public static uint Exec_mitie_total_word_feature_extractor_num_dimensions(IntPtr twfe)
        {
            return mitie_total_word_feature_extractor_num_dimensions(twfe);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mitie_total_word_feature_extractor_num_words_in_dictionary(IntPtr twfe);

        public static uint Exec_mitie_total_word_feature_extractor_num_words_in_dictionary(IntPtr twfe)
        {
            return mitie_total_word_feature_extractor_num_words_in_dictionary(twfe);
        }
        ...
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern int mitie_total_word_feature_extractor_get_feature_vector(IntPtr twfe,
                                                                                        [MarshalAs(UnmanagedType.LPStr)] string word,
                                                                                        out float result);

        public static int Exec_mitie_total_word_feature_extractor_get_feature_vector(IntPtr twfe,
                                                                                      string word,
                                                                                      out float result)
        {
            return mitie_total_word_feature_extractor_get_feature_vector(twfe,
                                                                         word,
                                                                         out result);
        }
        ...
        */
        [DllImport("mitie.dll",
            CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mitie_total_word_feature_extractor_get_words_in_dictionary(IntPtr twfe);

        public static List<string> Exec_mitie_tokenize(IntPtr twfe,
                                                       ref IntPtr unmanagedPtr,
                                                       bool freeUnmanaged = false)
        {
            unmanagedPtr = mitie_total_word_feature_extractor_get_words_in_dictionary(twfe);
            return Helpers.IntPtrToStringArrayAnsi(ref unmanagedPtr, freeUnmanaged);
        }
    }
}
